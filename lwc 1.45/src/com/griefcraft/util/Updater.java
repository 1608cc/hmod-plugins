...
/*     */ 
/*     */   
/*  62 */   private List<UpdaterFile> needsUpdating = new ArrayList<UpdaterFile>();
/*     */   
/*     */   public Updater() {
/*  65 */     enableSSL();
/*     */   }
...
/*     */   
/*     */   public void check() {
/*  74 */     String[] paths = { "lib/sqlite.jar", "lib/" + getOSSpecificFileName() }; byte b; int i;
/*     */     String[] arrayOfString1;
/*  76 */     for (i = (arrayOfString1 = paths).length, b = 0; b < i; ) { String path = arrayOfString1[b];
...
/*     */     }
/*     */     
/* 180 */     return String.valueOf(osname) + "-" + arch + ".lib";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\1608c\Desktop\LWC.jar!\com\griefcraf\\util\Updater.class
