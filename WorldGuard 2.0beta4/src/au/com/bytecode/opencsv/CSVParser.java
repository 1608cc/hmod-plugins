...
/* 220 */             i > 2 && nextLine.charAt(i - 1) != this.separator && nextLine.length() > i + 1 && nextLine.charAt(i + 1) != this.separator)
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* 273 */     return (inQuotes && nextLine.length() > i + 1 && nextLine.charAt(i + 1) == this.quotechar);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 286 */     return (inQuotes && nextLine.length() > i + 1 && (nextLine.charAt(i + 1) == this.quotechar || nextLine.charAt(i + 1) == this.escape));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\1608c\Desktop\worldguard\WorldGuard.jar!\au\com\bytecode\opencsv\CSVParser.class
