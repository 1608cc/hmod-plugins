...
/*  51 */     return names.<String>toArray(nameArray);
/*     */   }
/*     */ 
/*     */   
/*     */   public String[] getColumnValues(ResultSet rs) throws SQLException, IOException {
/*  56 */     List<String> values = new ArrayList<String>();
...
/*  64 */     return values.<String>toArray(valueArray);
/*     */   }
/*     */   
...
/*     */         break;
/*     */       case 16:
/* 116 */         b = rs.getBoolean(colIndex);
/* 117 */         value = Boolean.valueOf(b).toString();
/*     */         break;
/*     */       case 2005:
/*     */       case 2011:
/* 121 */         c = rs.getClob(colIndex);
/* 122 */         if (c != null) {
/* 123 */           value = read(c);
/*     */         }
/*     */         break;
...
/* Location:              C:\Users\1608c\Desktop\worldguard\WorldGuard.jar!\classes\au\com\bytecode\opencsv\ResultSetHelperService.class
