...
/*  70 */   private ResultSetHelper resultService = (ResultSetHelper)new ResultSetHelperService();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 233 */         if (this.quotechar != '\000') {
/* 234 */           sb.append(this.quotechar);
/*     */         }
/* 236 */         sb.append(stringContainsSpecialCharacters(nextElement) ? processLine(nextElement) : nextElement);
/*     */         
/* 238 */         if (this.quotechar != '\000')
...
/* 256 */       if (this.escapechar != '\000' && nextChar == this.quotechar) {
/* 257 */         sb.append(this.escapechar).append(nextChar);
/* 258 */       } else if (this.escapechar != '\000' && nextChar == this.escapechar) {
...
/* Location:              C:\Users\1608c\Desktop\worldguard\WorldGuard.jar!\classes\au\com\bytecode\opencsv\CSVWriter.class
