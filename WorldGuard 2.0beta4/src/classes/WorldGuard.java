...
/*     */ import Plugin;
/*     */ import PluginListener;
/*     */ import PluginLoader;
/*     */ import WorldGuardListener;
/*     */ import etc;
...
/*  93 */       logger.log(Level.WARNING, "WorldGuard: Your version of hMod does not support " + 
/*  94 */           concatMissingFeatures(missingFeatures) + ".");
/*     */     } else {
...
/* 111 */       etc.getLoader().addListener(hook, (PluginListener)this.listener, this, priority);
/* 112 */       return true;
...
/*     */     try {
/* 157 */       String classContainer = WorldGuard.class.getProtectionDomain()
/* 158 */         .getCodeSource().getLocation().toString();
...
/* Location:              C:\Users\1608c\Desktop\worldguard\WorldGuard.jar!\classes\WorldGuard.class
